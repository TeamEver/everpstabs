...
<div class="panel">
    <div class="panel-body">
        <div class="col-xs-12 col-lg-6">
			<h3><i class="icon icon-smile"></i> {l s='Ever PS Tabs' mod='everpstabs'}</h3>
			<img id="everlogo" src="{$everpstabs_dir|escape:'htmlall':'UTF-8'}logo.png" style="max-width: 120px;">
			<p>
				<strong>{l s='Welcome to Ever PS Tabs !' mod='everpstabs'}</strong><br />
				{l s='Thanks for using Team Ever\'s module' mod='everpstabs'}</a><br />
			</p>
        </div>
        <div class="col-xs-12 col-lg-6">
            <p class="alert alert-warning">
                {l s='This module is free and will always be ! You can support our free modules by making a donation by clicking the button below' mod='everpstabs'}
            </p>
